...
export default function Header() {
  ...
  const [n_unreadCount, setNUnreadCount] = useState<number>(0)
  ...
  useEffect(() => {
    ...
    async function fetchUnreadNotifications() {
      try {
        const data = await apiFetchAuth<{ unread_count: number }>('/api/notifications/unread_count/')
        setNUnreadCount(data.unread_count)
              ...
              <div className="flex items-center mr-2">
                ...
                <Link href="/notifications">
                  <div className="relative  lg:w-7 lg:h-7 w-6 h-6 flex-shrink-0">
                    <svg className="w-full hover:scale-105 transition h-full block" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {n_unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] text-xs flex items-center justify-center bg-red-500 text-white font-bold rounded-full">
                ...
                <Link href={"/messages"} className="relative">
                  <svg width="25" height="25" className="invert mr-3 transition hover:scale-105" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"/favorites"}>
                  <svg className="mr-1.5 transition hover:scale-105" width="28" height="28" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {user ? (
                  <div className="relative group">
                    <div className="flex items-center cursor-pointer">
                      ...
                      <img
                        className="rounded-full bg-white max-w-10 max-h-10 min-w-10 min-h-10 object-cover"
