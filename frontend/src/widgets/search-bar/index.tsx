...
export default function SearchBar() {
  ...
  return (
    <div className="relative flex items-center lg:mt-4 mt-2 lg:mb-2 mb-0 lg:mt-0 lg:mb-0">
      <input
        value={query}
        onChange={(e) => setQuery(e.target.value)}
        className="p-4 border-0.5  border text-gray-900 border-black rounded-3xl ml-2 lg:h-[44px] h-[35px] lg:w-[510px] w-58"
      ...
      <Link
        href={`/search?query=${encodeURIComponent(query)}`}
        className="hover:opacity-80 transition bg-black w-[82px] absolute lg:right-0 right-[92px] lg:h-[44px] h-[35px] rounded-3xl flex justify-center items-center"
      >
        <svg
          width="24"
          height="24"
      ...
      <div className="absolute lg:hidden right-10 top-0.5">
        <Link className="relative" href={"/notifications"}>
          <svg className="mr-3 hover:scale-105 invert w-8" width="34" height="34" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M10.7182 22.0474C11.1063 21.8221 11.6035 21.9543 11.8287 22.3425C11.9478 22.5476 12.1186 22.718 12.3241 22.8365C12.5297 22.9549 12.7628 23.0172 13 23.0172C13.2373 23.0172 13.4704 22.9549 13.6759 22.8365C13.8815 22.718 14.0524 22.5476 14.1714 22.3425C14.3965 21.9543 14.8938 21.8221 15.2818 22.0474C15.67 22.2725 15.8022 22.7697 15.577 23.1579C15.3151 23.6093 14.9393 23.984 14.487 24.2446C14.0347 24.505 13.522 24.6422 13 24.6422C12.4782 24.6422 11.9653 24.505 11.5131 24.2446C11.0608 23.984 10.6849 23.6093 10.4231 23.1579C10.1979 22.7697 10.33 22.2725 10.7182 22.0474Z" fill="white"/>
                              ...
                              {n_unreadCount > 0 && (
                      <span className="absolute -top-1 right-2 bg-red-500 text-white text-sm font-bold px-1 py-0 rounded-full">
